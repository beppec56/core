...
namespace webdav_ucp
{
    ...
    public:
        ...
        OUString GetMainUri( INetURLObject::DecodeMechanism eMechanism = INetURLObject::NO_DECODE ) const {
        ...
        inline OUString GetPathQueryFragment(
    ...
    inline OUString DAVUri::GetPathQueryFragment( INetURLObject::DecodeMechanism eMechanism ) const
    {
    ...
    inline OUString DAVUri::GetPercDecodedPathBaseName() const
    {
        OUString aRet( m_TheURL.getName( INetURLObject::LAST_SEGMENT, true, INetURLObject::DECODE_WITH_CHARSET ) );
        if ( m_TheURL.HasParam() )
        {
            aRet += "?";
            aRet += m_TheURL.GetParam( INetURLObject::NO_DECODE );
        ...
        throw ( DAVException )
    {
        ...
        OUString aEscapedUri( GetMainUri() );
        OString theInputUri(
