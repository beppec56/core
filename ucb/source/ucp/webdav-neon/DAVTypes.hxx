...
*/
    ...
    private:
        ...
        bool    m_isDAVCapabilitiesValid; // true if this struct contains valid data
        bool    m_isClass1;
        bool    m_isClass2;
        bool    m_isClass3;
...
// needed to detect if the server is Sharepoint-like
    ...
    public:
        ...
        bool isDAVCapabilitiesValid() { return m_isDAVCapabilitiesValid; };
        void setDAVCapabilitiesValid( bool DAVCapabilitiesValid = true  ) { m_isDAVCapabilitiesValid = DAVCapabilitiesValid; };
    ...
    private:
        ...
        /// remove the last '/' in aUrl, if exists
        void normalizeURLLastChar( OUString& aUrl ) {
            if ( aUrl.getLength() > 1 &&
