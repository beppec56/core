...
{
    SAL_WARN_A("ucb.ucp.webdav","DAVAuthListener_Impl::authenticate - called");
    if ( m_xEnv.is() )
    {
            ...
            if ( xSelection.is() )
            {
                ...
                if ( !xAbort.is() )
                {
                    ...
                    if ( bUseSystemCredentials )
                    {
                        ...
                        inoutUserName.clear();
                        outPassWord.clear();
                        SAL_INFO("ucb.ucp.webdav","DAVAuthListener_Impl::authenticate: System credentials where selected");
                    }
                    else
                    {
