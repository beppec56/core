...
//#if defined SAL_LOG_INFO
            {
                ...
                while ( it3 != end3 )
                {
                    ...
                    SAL_INFO_A( "ucb.ucp.webdav", "resource URL: <" << (*it3).uri << ">, unescaped to: <" << aCurrPath << "> )" );
                    ...
                    SAL_INFO_A( "ucb.ucp.webdav", "  property Names: ");
                    while ( it4 != end4 )
                    {
                        SAL_INFO_A( "ucb.ucp.webdav", "   " << (*it4).Name );
                        ++it4;
                    }
                    ++it3;
                }
...
//#endif
        ...
        {
            SAL_WARN_A( "ucb.ucp.webdav", "Running PROPFIND: DAVException" );
