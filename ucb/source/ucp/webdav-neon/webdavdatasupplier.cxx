...
//#if defined SAL_LOG_INFO
            {
                ...
                while ( it3 != end3 )
                {
                    ...
                    SAL_INFO_DL( "ucb.ucp.webdav", "getData() - resource URL: <" << (*it3).uri << ">, unescaped to: <" << aCurrPath << "> )" );
                    ...
                    while ( it4 != end4 )
                    {
                        SAL_INFO_DL( "ucb.ucp.webdav", "PROPFIND - property name: " << (*it4).Name );
                        ++it4;
                    }
                    ++it3;
                }
...
//#endif
        ...
        {
            SAL_WARN_DL( "ucb.ucp.webdav", "Running PROPFIND: DAVException" );
