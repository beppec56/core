        ...
        catch ( DAVException const & e )
        {
            ...
            switch( e.getError() )
            {
                ...
                case DAVException::DAV_HTTP_TIMEOUT:
                {
                    ...
                    // Perhaps OPTIONS is silently ignored, or
                    // resource is NON_DAV, or not advertising it, so act as a standard WEB site
                    // check for the physical URL resource existence, using a simple HEAD command
                    // Unfortunately this has a side effect of doubling the timeout time if the connection
