...
namespace tools {
    ...
    TOOLS_DLLPUBLIC void createAbsoluteLogFileSystemName(OUString & inFileNameRadix,  OUString & aSystemPathReturned, bool createAbsoluteLogFileSystemName );
    TOOLS_DLLPUBLIC void deleteOlderLogFiles(int nFileAgeInHours, OUString & sFileNameRadix);
